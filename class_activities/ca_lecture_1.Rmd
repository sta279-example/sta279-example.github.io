...
**Instruction:** Work with a neighbor to answer the following questions. Solutions will be posted on the course website. To get started, download the [class activity template](https://sta279-example.github.io/class_activities/ca_lecture_1_template.qmd) file.
...
<font size="2"> The R Markdown formatting for this activity was adapted from a template provided by Dr. Lucy D'Agostino-McGowan</font> 
