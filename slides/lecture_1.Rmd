...
* Student participation:
    ...
    * Your turn: class activity at the end of the lesson
...
**Question:** What are some big-picture strategies (not specific calculation details) you could use to try and find this probability?
...
for(i in 1:nsim){
  randomized_hats <- sample(hats, size = M, 
                            replace = FALSE)
  results[i] <- sum(hats == randomized_hats) > 0
}
