...
* Download the [HW 1 template](https://sta279-example.github.io/homework/hw_1_template.qmd), and open the template (a Quarto document) in RStudio. 
...
<font size="2"> The R Markdown formatting for this assignment was adapted from a template provided by Dr. Lucy D'Agostino-McGowan</font> 
